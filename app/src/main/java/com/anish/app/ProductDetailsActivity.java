...
import com.anish.app.CreateChannel.NotificationClass;
import com.anish.app.Model.Products;
import com.anish.app.Prevalent.Prevalent;
...
public class ProductDetailsActivity extends AppCompatActivity
{
    ...
    private void displayCartNotification()
    {
// Create an explicit intent for an Activity in your app
        Intent intent = new Intent(this, MainActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, intent, 0);
        Notification notification= new NotificationCompat.Builder(this,NotificationClass.channel_1)
                .setSmallIcon(R.drawable.techmart)
                .setContentTitle("Cart")
                .setContentText("Sucessfully Added to cart")
